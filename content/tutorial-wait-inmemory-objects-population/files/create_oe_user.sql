SET ECHO ON
ADMINISTER KEY MANAGEMENT SET KEYSTORE OPEN IDENTIFIED BY "Welcome-1";
ADMINISTER KEY MANAGEMENT SET KEY IDENTIFIED BY "Welcome-1" WITH BACKUP;
...
CREATE USER oe IDENTIFIED BY "Welcome-1" DEFAULT TABLESPACE example;
